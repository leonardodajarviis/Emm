...
namespace Emm.Infrastructure.Migrations
{
    ...
    [Migration("20260114031006_LEO2026")]
    partial class LEO2026
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emm.Domain.Entities.Inventory.Item", b =>
                {
                    ...
                    b.HasIndex("UnitOfMeasureCategoryId");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.Operations.OperationShift", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentShiftLogId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.Operations.OperationShiftReadingSnapshot", b =>
                {
                    b.Property<Guid>("OperationShiftId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("OperationShiftId", "AssetId", "ParameterId");

                    b.ToTable("OperationShiftReadingSnapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Emm.Domain.Entities.Operations.ShiftLogCheckpoint", b =>
                {
                    ...
                    b.Property<int>("CheckpointOrder")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.UnitOfMeasureCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.UnitOfMeasureCategoryLine", b =>
                {
                    b.Property<Guid>("UnitOfMeasureCategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("UnitOfMeasureCategoryId", "UnitOfMeasureId");

                    b.HasIndex("UnitOfMeasureId");

                    b.ToTable("UnitOfMeasureCategoryLines", (string)null);
                });
            ...
            modelBuilder.Entity("Emm.Domain.Entities.UnitOfMeasureCategory", b =>
                {
                    b.OwnsOne("Emm.Domain.ValueObjects.AuditMetadata", "Audit", b1 =>
                        {
                            b1.Property<Guid>("UnitOfMeasureCategoryId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("UnitOfMeasureCategoryId");

                            b1.ToTable("UnitOfMeasureCategories");
