...
namespace Emm.Infrastructure.Migrations
{
    ...
    [Migration("20251008140538_Comebanknow")]
    partial class Comebanknow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.MaintenancePlanInstance", b =>
                {
                    ...
                    b.HasIndex("AssetId", "MaintenancePlanDefinitionId")
                        .HasDatabaseName("IX_MaintenancePlanInstances_AssetId_PlanDefinitionId");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.MaintenancePlanJobStepDefinition", b =>
                {
                    ...
                    b.Property<long?>("MaintenancePlanDefinitionId1")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MaintenancePlanDefinitionId1");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.ParameterBasedMaintenanceTriggerInstance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ParameterId", "ActualValue");

                    b.HasIndex("ParameterId", "TriggerDateTime");

                    b.ToTable("ParameterBasedMaintenanceTriggerInstances", (string)null);
                });

            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTrigger", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TimeBasedMaintenanceTriggers", (string)null);
                });

            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTriggerInstance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("ActualTriggerDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ScheduledDate", "ActualTriggerDate");

                    b.ToTable("TimeBasedMaintenanceTriggerInstances", (string)null);
                });
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.MaintenancePlanInstance", b =>
                {
                    ...
                    b.HasOne("Emm.Domain.Entities.AssetCatalog.MaintenancePlanDefinition", "MaintenancePlanDefinition")
                        .WithMany()
                        .HasForeignKey("MaintenancePlanDefinitionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("MaintenancePlanDefinition");
                });
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.MaintenancePlanJobStepDefinition", b =>
                {
                    ...
                    b.HasOne("Emm.Domain.Entities.AssetCatalog.MaintenancePlanDefinition", null)
                        .WithMany("JobSteps")
                        .HasForeignKey("MaintenancePlanDefinitionId1");
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.ParameterBasedMaintenanceTriggerInstance", b =>
                {
                    b.HasOne("Emm.Domain.Entities.AssetCatalog.MaintenancePlanInstance", "MaintenancePlanInstance")
                        .WithOne("EfParameterBasedTriggerInstance")
                        .HasForeignKey("Emm.Domain.Entities.AssetCatalog.ParameterBasedMaintenanceTriggerInstance", "MaintenancePlanInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MaintenancePlanInstance");
                });

            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTrigger", b =>
                {
                    b.HasOne("Emm.Domain.Entities.AssetCatalog.MaintenancePlanDefinition", null)
                        .WithOne("TimeBasedTrigger")
                        .HasForeignKey("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTrigger", "MaintenancePlanDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTriggerInstance", b =>
                {
                    b.HasOne("Emm.Domain.Entities.AssetCatalog.MaintenancePlanInstance", "MaintenancePlanInstance")
                        .WithOne("EfTimeBasedTriggerInstance")
                        .HasForeignKey("Emm.Domain.Entities.AssetCatalog.TimeBasedMaintenanceTriggerInstance", "MaintenancePlanInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Emm.Domain.Entities.AssetCatalog.MaintenancePlanInstance", b =>
                {
                    ...
                    b.Navigation("EfParameterBasedTriggerInstance");

                    b.Navigation("EfTimeBasedTriggerInstance");
                });
